...
public abstract class Worker extends Person{
	...
	public Worker(String i_ID, String i_FirstName, String i_LastName, String i_PhoneNumber,
	...
	public Worker(Worker i_Worker){
		this(i_Worker.m_ID, i_Worker.m_FirstName, i_Worker.m_LastName, i_Worker.m_PhoneNumber,
				i_Worker.m_Branch,"", i_Worker.m_BankAccountNumber);
		m_WorkerNumber = i_Worker.m_WorkerNumber;
	}
	
	public Worker(JSONObject i_WorkerData){
		super(i_WorkerData.getString("ID"), i_WorkerData.getString("firstName"),
				i_WorkerData.getString("lastName"), i_WorkerData.getString("phoneNumber"));
